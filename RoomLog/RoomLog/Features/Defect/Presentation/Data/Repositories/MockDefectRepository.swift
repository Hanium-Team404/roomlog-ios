...
// TODO: 서버 연동 시 DIContainer에서 DefectRepository로 교체
final class MockDefectRepository: DefectRepositoryProtocol {
    ...
    func getDefectReport(roomId: Int) async throws -> DefectReport {
        ...
        let defects = [
            DefectReportDetail(id: "1", imageURL: nil, type: "균열", severity: .high, description: "벽면 균열 발견", repairCost: 80000, defectArea: 0.3, location: "거실 북쪽 벽", discoveredDate: Date(), memo: nil, x: 0.3, y: 0.4, z: nil),
            DefectReportDetail(id: "2", imageURL: nil, type: "곰팡이", severity: .medium, description: "화장실 천장 곰팡이", repairCost: 50000, defectArea: 0.2, location: "화장실 천장", discoveredDate: Date(), memo: nil, x: 0.7, y: 0.2, z: nil),
            DefectReportDetail(id: "3", imageURL: nil, type: "도배 손상", severity: .low, description: "벽지 뜯김", repairCost: 20000, defectArea: 0.1, location: "침실 동쪽 벽", discoveredDate: Date(), memo: nil, x: 0.5, y: 0.6, z: nil)
        ]
